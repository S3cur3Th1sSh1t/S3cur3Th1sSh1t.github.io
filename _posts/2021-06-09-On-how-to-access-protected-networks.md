...
This post is about common misconfigurations and attack szenarios that enable an attacker to access seperated networks with critical systems or sensitive data. The content is heavily inspired by my personal experience in real world projects and company networks.
